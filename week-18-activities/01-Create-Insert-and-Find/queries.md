...
db.places.insert({"continent": "North America", "country":"USA", "majorcities": ["New York", "Boston", "Chicago", "Los Angeles"]})
db.places.insert({"continent": "Europe", "country":"Germany", "majorcities": ["Frankfurt", "Berlin", "Cologne", "Munich"]})
```
...
* Example: `db.places.find({_id: ObjectId("5ab67dc0e49fafcb9ff752b2")})`
